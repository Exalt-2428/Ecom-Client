    ...
    <header className="bg-[#071c29] w-full text-left text-[2rem] text-gray-200 py-4">
      <div className="z-20 px-4 xs:px-12 sm:px-20 lg:px-28 xl:px-16 hxl:px-28 2xl:px-64 3xl:px-96 text-[1rem] flex justify-between items-center">
        <div className="flex gap-8">
          <a
            href="/"
            className="text-[#29b6ff] hover:text-white transition-colors duration-300 flex items-center"
          >
          ...
          {user?.isSuperAdmin && (
            <a
              ...
              className="text-red-500 hover:text-white transition-colors duration-300 flex items-center"
            >
        ...
        {user ? (
          <div className="flex gap-8">
            <h1 className="text-[#29b6ff] flex items-center">
              ...
              <span className="ml-2">Welcome, {user.firstName}! </span>
            </h1>
            <button
              className="text-[#29b6ff] hover:text-white transition-colors duration-300 flex items-center"
          ...
          <div className="flex gap-4">
            <a
              href="/auth/login"
              className="text-[#29b6ff] hover:text-white transition-colors duration-300"
            >
              Login
            </a>
            <a
